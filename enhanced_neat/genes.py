...
class BaseGene(object):
    ...
    def __init__(self, key):
        ...
        # self.add_node_prob = 0.1
        self.add_connection_prob = 0.1
        self.remove_node_prob = 0.1
        self.remove_connection_prob = 0.1
    ...
    def crossover(self, gene2):
        ...
        # new_gene = self.__class__(self.key)
        # attributes = self._gene_attributes
        # crossover_point1 = randint(0, len(attributes) - 1)
        # crossover_point2 = randint(crossover_point1, len(attributes))

        # for i in range(len(attributes)):
        #     if i < crossover_point1 or i > crossover_point2:
        #         setattr(new_gene, attributes[i].name, getattr(self, attributes[i].name))
        #     else:
        #         setattr(new_gene, attributes[i].name, getattr(gene2, attributes[i].name))
